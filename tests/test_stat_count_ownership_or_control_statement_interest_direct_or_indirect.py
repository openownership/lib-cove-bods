...
def test_schema_0_2():
    ...
    assert 'count_ownership_or_control_statement_interest_direct_or_indirect' not in results['statistics'].keys()
...
def test_schema_0_3_basic_1():
    ...
    assert 1 == results['statistics']['count_ownership_or_control_statement_interest_direct_or_indirect']['direct']
    assert 0 == results['statistics']['count_ownership_or_control_statement_interest_direct_or_indirect']['indirect']
    assert 0 == results['statistics']['count_ownership_or_control_statement_interest_direct_or_indirect']['unknown']
