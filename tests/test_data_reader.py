...
def test_sample_but_no_change_get_all_data_1():
    ...
    data_reader = libcovebods.data_reader.DataReader(
        json_filename, sample_mode=True, sample_mode_max_row_count_per_statement_type=50
    )
    actual = data_reader.get_all_data()
...
def test_sample_some_removed_get_all_data_1():
    ...
    data_reader = libcovebods.data_reader.DataReader(
        json_filename, sample_mode=True, sample_mode_max_row_count_per_statement_type=1
    )
    actual = data_reader.get_all_data()
...
def test_sample_bad_statements_are_included_get_all_data_1():
    ...
    data_reader = libcovebods.data_reader.DataReader(
        json_filename, sample_mode=True, sample_mode_max_row_count_per_statement_type=2
    )
    actual = data_reader.get_all_data()
