...
def test_schema_0_1_file_1():
    ...
    json_filename = os.path.join(os.path.dirname(
        os.path.realpath(__file__)), 'fixtures', '0.1', 'beneficialOwnershipOrControl_but_unspecified_person_1.json'
    )
...
def test_schema_0_1_file_2():
    ...
    cove_temp_folder = tempfile.mkdtemp(prefix='lib-cove-bods-tests-', dir=tempfile.gettempdir())
    json_filename = os.path.join(os.path.dirname(
        os.path.realpath(__file__)), 'fixtures', '0.1', 'beneficialOwnershipOrControl_but_unspecified_person_2.json'
    )
...
def test_schema_0_2_file_1():
    ...
    cove_temp_folder = tempfile.mkdtemp(prefix='lib-cove-bods-tests-', dir=tempfile.gettempdir())
    json_filename = os.path.join(os.path.dirname(
        os.path.realpath(__file__)), 'fixtures', '0.2', 'beneficialOwnershipOrControl_but_unspecified_person_1.json'
    )
